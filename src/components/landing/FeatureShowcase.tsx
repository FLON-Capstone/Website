...
const features = [
  {
    ...
    description: 'Every day starts with a personalized 15-minute audio briefing, with deadlines, flagged emails, today\'s schedule, upcoming events, and more. Think the Daily from the New York Times but for your life.',
    bullets: ['Compiled from your calendar, inbox, and coursework', 'Ready every morning before you open your device', 'Skip tracks, replay, and mark items done'],
  ...
  },
  {
    ...
    headline: 'Never miss a detail, from office hours to your daily briefing.',
    description: 'Record any lecture or meeting. Reverb transcribes in real time, summarizes the key points, and flags action items so nothing falls through the cracks.',
    bullets: ['Live transcription as you record', 'Auto-detected action items and deadlines', 'Searchable from day one'],
  ...
  },
  {
    ...
    description: 'All your tasks, flagged emails, and deadlines in one prioritized queue. Reverb surfaces what matters and tells you how long each item actually takes.',
    bullets: ['Priority-sorted with urgency indicators', 'Time estimates so you can plan your day', 'One-tap to add tasks from any transcript'],
